...
- (void)openInThemeableBrowser:(NSURL*)url withOptions:(NSString*)options
{
    ...
    if (self.themeableBrowserViewController == nil) {
        self.themeableBrowserViewController = [[CDVThemeableBrowserViewController alloc]
                                             initWithBrowserOptions:browserOptions  navigationDelete:self
...
#ifdef __CORDOVA_4_0_0
        _webViewDelegate = [[CDVWebViewUIDelegate alloc] initWithTitle:[[NSBundle mainBundle] objectForInfoDictionaryKey:@"CFBundleDisplayName"]];
#else
