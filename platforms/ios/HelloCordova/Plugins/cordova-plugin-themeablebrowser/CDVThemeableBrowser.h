...
#ifdef __CORDOVA_4_0_0
    CDVWebViewUIDelegate* _webViewDelegate;
#else
...
- (id)initWithBrowserOptions: (CDVThemeableBrowserOptions*) browserOptions
            navigationDelete:(CDVThemeableBrowser*) navigationDelegate statusBarStyle:(UIStatusBarStyle) statusBarStyle;
